                    ...
                    <div class="user-header">
                        <div class="media-img-wrap">
                            <div class="avatar avatar-online">
                                <img src="{{ url('images/admin/' . Auth()->user()->image) }}" alt="User Image" class="avatar-img rounded-circle">
                            </div>
                        </div>
                        <div class="user-text">
        ...
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="{{ route('states.index') }}"><i class="fa fa-map-signs"></i> <span>States</span></a>
                    </li>
                    <li>
                        <a href="{{ route('admins.index') }}"><i class="fa fa-magic"></i> <span>Admins</span></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{route('appointments.index')}}"><i class="fe fe-user"></i> <span>Appointments</span></a>
                    </li>
                    {{-- <li>
                    ...
                    <li>
                        <a href="{{ route('admin.show',Auth()->user()->id) }}"><i class="fe fe-user-plus"></i> <span>Profile</span></a>
                    </li>
                    {{-- <li class="submenu">
