                    ...
                    <form action="{{ route('doctors.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="first_name" value="{{ old('first_name') }}" class="form-control" id="first_name" placeholder="First name" required>
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="mobile" value="{{ old('mobile') }}" class="form-control" id="mobile" placeholder="Mobiel" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control" name="city_id" id="city_id" onchange="getCityStates()">
                        ...
                        <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-0">
                                    <textarea class="form-control" rows="5" name="about" value="{{ old('about') }}"></textarea>
                                </div>
                            </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3 pl-0">
                                <label class="col-lg-3 col-form-label">Pricing</label>
                                    <div class="col-lg-9">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="pricing" id="pricing_free" value="Free">
                                            <label class="form-check-label" for="pricing_free">
                                                Free
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="pricing" id="pricing_perHour" value="PerHour">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="hour_price" value="{{ old('hour_price') }}" class="form-control" id="hour_price" placeholder="Hour Price" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="validationCustom01">Facebook url</label>
                                <input type="text" name="facebook" value="{{ old('facebook') }}" class="form-control" id="facebook" placeholder="Facebook url">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="validationCustom02">Twitter url</label>
                                <input type="text" name="twitter" value="{{ old('twitter') }}" class="form-control" id="twitter" placeholder="Twitter url">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="validationCustom01">Linked in url</label>
                                <input type="text" name="linked" value="{{ old('linked') }}" class="form-control" id="linked" placeholder="Linked in url">
                            </div>
                        </div>
