        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('specialities.update',$speciality->id) }}" method="POST" id="create_speciality_form" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label for="post title">Title:</label>
                            <input type="text" class="form-control" name="title" value="{{ $speciality->title }}" placeholder="Add a New Post">
                        </div>
                        <div class="form-group">
                            <label for="post description">Description:</label>
                            <textarea class="form-control" rows="2" name="description" placeholder="Add a description">{{ $speciality->description }}</textarea>
                        </div>
                        <div class="form-group">
                            <img src="{{ url('images/speciality/' . $speciality->image) }}" style="width: 70px;height: 70px;">
                        </div>
                        <div class="row">
                            ...
                            <div class="form-group col-md-3 ml-5">
                                ...
                                <div class="status-toggle">
                                    ...
                                    @if ($speciality->status === 'Active') checked @endif >
